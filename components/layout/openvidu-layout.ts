...
class OpenViduLayout {
  ...
  positionElement(elem: any, x: any, y: any, width: any, height: any, animate: any) {
  ...
  getCSSNumber(elem: any, prop: any) {
    const cssStr = $(elem).css(prop) as unknown as string
  ...
  getBestDimensions(minR: any, maxR: any, count: any, WIDTH: any, HEIGHT: any, targetHeight: any) {
    ...
    return {
      ...
      ratio: targetWidth && targetHeight / targetWidth,
    }
  }
  ...
  updateLayout() {
    ...
    let id = this.layoutContainer && this.layoutContainer.id
    if (!id) {
